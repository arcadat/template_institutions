          ...
          <nav>
            <div class="container">
              <div class="nav-wrapper">
                ...
                <?php if (!empty($main_data->logo_i)): ?>
                    <img src="<?php echo $main_data->root_logo.$main_data->logo_i ?>" alt="<?php echo $main_data->name_i ?>">
                <?php else: ?>
              ...
              <div class="slider">
                ...
                if ($covers->covers):
                    foreach ($photos_covers as $photo_cover):
                        foreach ($photo_cover as $key => $value):
                        ?>
                        <li>
                            <img src="<?php echo $main_data->root_covers.$value ?>">
                            <div class="caption center-align">
                                <h3><?php echo $main_data->name_i ?></h3>
                                <h5 class="light grey-text text-lighten-3"><?php echo $main_data->slogan_i ?></h5>
                            </div>
                        </li>
                        <?php
                        endforeach;
                    ...
                    <div class="portfolio-bottom-inner">
                        ...
                        if ($installations->installations):
                            foreach ($photos_installations as $photo_installation):
                                foreach ($photo_installation as $key => $value):
                                ?>
                            <div class="mix">
                                <a href="#" class="portfolio-thumbnill">
                                <img src="<?php echo $main_data->root_thumbs_installations.$value ?>" alt="img">
                                <i class="material-icons view-icon">pageview</i>
                                </a>
                                <div class="portfolio-detail">
                                    <a href="#" class="modal-close-btn"><span class="fa fa-times"></span></a>
                                    <img src="<?php echo $main_data->root_installations.'/'.$value ?>" alt="img">
